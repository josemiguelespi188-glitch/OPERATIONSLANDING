...
export default function HomePage() {
  ...
  return (
    <PageShell navItems={getPublicNavItems()} footer={<PublicSidebarFooter />}>
      <header className="flex items-center justify-between border-b border-axis-base/30 bg-white px-10 py-6">
      ...
      <section className="px-10 pb-24 pt-10">
        <p className="max-w-lg text-sm text-axis-core/55">
          Internal Request Center. Choose the process you need below to start a new request.
        </p>
