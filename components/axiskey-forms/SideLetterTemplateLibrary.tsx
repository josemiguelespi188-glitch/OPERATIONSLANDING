...
export function SideLetterTemplateLibrary({
  ...
  return (
    <div className="mt-10">
      <h2 className="text-base font-bold text-black">Common Side Letter Templates</h2>
      <p className="mt-1 text-sm text-gray-600">
        Pick a starting point — it prefills the request type and description below. You can still
