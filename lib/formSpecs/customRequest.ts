...
export const customRequestSpec: FormSpec = {
  ...
  submissionMapping: {
    ...
    // Confirmed against the real "Custom Request" ClickUp list (Aug
    // 2026) — see CUSTOM_FIELD_MAP in lib/integrations/clickup.ts.
    customFields: [
